...
L["Log entries to show in death log (reduce if game crashes)"] = "Записи журнала для отображения в журнале смертей (уменьшите, если игра вылетает)"
